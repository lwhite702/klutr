---
title: "Getting Started with Klutr - Your First Drop"
description: "Learn how to capture your first note and start building your second brain. Quick guide to Stream, Boards, and automatic organization."
openGraph:
  title: "Getting Started with Klutr"
  description: "Capture your first drop and watch Klutr automatically organize your thoughts. Simple, fast, and clutter-free."
---

# Getting Started

Welcome to Klutr! This guide will help you capture your first drop and understand how the Stream interface works. We'll have you dumping thoughts and clearing clutter in minutes.

![Getting started with Klutr](/illustrations/ux-colors/Avatar-Neutral-Check--Streamline-Ux.svg)
...
- Speak naturally—we'll transcribe it automatically
...
_Questions? Explore the other guides above, or check out [Overview](/overview) to understand how Klutr works._
