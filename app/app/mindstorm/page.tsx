...
const MOCK_CLUSTERS = [
  {
    name: "Ideas",
    noteCount: 5,
    summary: "You're exploring content ideas and side hustles. Strong focus on AI-powered tools and creator economy.",
  },
  {
    name: "Tasks",
    noteCount: 8,
    summary: "Mix of client work follow-ups and personal todos. Several items marked urgent.",
  },
  {
    name: "Contacts",
    noteCount: 12,
    summary: "Growing network of founders, developers, and potential collaborators from recent conferences.",
  },
  {
    name: "Links",
    noteCount: 15,
    summary: "Saved articles on productivity, AI developments, and startup advice. Heavy tech focus.",
  },
  {
    name: "Voice Notes",
    noteCount: 4,
    summary: "Quick voice memos about podcast ideas and random thoughts while commuting.",
  },
  {
    name: "Misc",
    noteCount: 9,
    summary: "Shopping lists, random reminders, and things that don't fit elsewhere.",
  },
]
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {clusters.map((cluster) => (
          <Card key={cluster.name} className="hover:shadow-md transition-shadow">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground leading-relaxed">{cluster.summary}</p>
            </CardContent>
          </Card>
        ))}
      </div>
      ...
      <Sheet open={showGraphView} onOpenChange={setShowGraphView}>
        <SheetContent side="bottom" className="h-[80vh]">
          <SheetHeader>
            ...
            <SheetDescription>Interactive idea map coming soon</SheetDescription>
          </SheetHeader>
          <div className="mt-6 flex items-center justify-center h-full">
            <div className="text-center space-y-4">
              <p className="text-muted-foreground">
                Coming soon: interactive idea map. Nodes = your thoughts. Edges = semantic similarity.
              </p>
              {demoMode && (
                <div className="mt-8 p-8 border-2 border-dashed rounded-lg">
                  <p className="text-sm text-muted-foreground">
                    [Demo visualization would show 6 mock nodes with connecting lines representing semantic
