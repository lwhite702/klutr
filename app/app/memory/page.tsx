...
const MOCK_TIMELINE = [
  {
    week: "2025-10-20",
    count: 12,
    topics: ["AI", "pricing", "founder anxiety"],
  },
  ...
  const handleRevisitWeek = async (week: string) => {
    ...
    try {
      const data = await apiGet<NoteDTO[]>(
        `/api/memory/notes-by-week?week=${week}`
      );
      setWeekNotes(data);
    } catch (error) {
          ...
          <div className="flex items-center gap-2">
            <div>
              ...
              <p className="text-muted-foreground">
                Travel back through your captured thoughts.
              </p>
            </div>
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <p className="max-w-xs">
                    See how your brain changes over time. Track themes across
                    weeks.
                  </p>
                </TooltipContent>
              </Tooltip>
        ...
        >
          ...
          >
            <SheetHeader>
              ...
              <SheetDescription>
                {weekNotes.length} notes from this week
              </SheetDescription>
            </SheetHeader>
