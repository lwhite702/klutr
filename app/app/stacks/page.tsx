...
const MOCK_STACKS = [
  {
    name: "Podcast Ideas",
    noteCount: 7,
    summary: "Ideas around creator economy + AI clips. Potential guests and episode formats.",
    pinned: false,
  },
  {
    name: "2025 Goals",
    noteCount: 3,
    summary: "Saving money, building product, time freedom. Focus on sustainable growth.",
    pinned: true,
  },
  {
    name: "Client Work",
    noteCount: 5,
    summary: "Follow-ups and deliverables for freelance clients. Deadlines and project notes.",
    pinned: false,
  },
  {
    name: "Learning Resources",
    noteCount: 12,
    summary: "Courses, tutorials, and articles saved for later. Heavy focus on AI and web development.",
    pinned: false,
  },
  {
    name: "Side Project Ideas",
    noteCount: 9,
    summary: "Various SaaS and product ideas. Some validated, others just random thoughts.",
    pinned: false,
  },
  {
    name: "Personal",
