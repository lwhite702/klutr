...
function CategoryBadge({ category }: { category: string | null }) {
  ...
  const categoryConfig = {
    feature: { label: "Feature", className: "bg-[var(--klutr-coral)]/20 text-[var(--klutr-coral)]" },
    ui: { label: "UI", className: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400" },
    infra: { label: "Infra", className: "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400" },
    docs: { label: "Docs", className: "bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-300" },
    risk: { label: "Risk", className: "bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400" },
  }

  const config = categoryConfig[category as keyof typeof categoryConfig] || categoryConfig.docs
        ...
        <AnimatedSection className="space-y-12">
          <AnimatedItem className="text-center space-y-4 max-w-3xl mx-auto">
            ...
            <p className="text-lg text-[var(--klutr-text-primary-light)]/70 dark:text-[var(--klutr-text-primary-dark)]/70">
              See what's new in Klutr. We ship updates regularly to make your note-taking experience better.
            </p>
          </AnimatedItem>
          ...
          {changelogEntries.length === 0 ? (
            <AnimatedItem className="text-center py-12">
              <p className="text-[var(--klutr-text-primary-light)]/70 dark:text-[var(--klutr-text-primary-dark)]/70">
                Changelog entries will appear here once they're added to BaseHub.
              </p>
            </AnimatedItem>
          ) : (
