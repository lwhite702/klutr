      ...
      <header>
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {navigationItems.map((item) => (
              <a
                key={item.title}
                href={item.href}
                className="text-sm font-mono text-foreground hover:text-[var(--klutr-coral)] transition-colors"
              >
                {item.title}
              </a>
            ))}
          ...
          <div className="flex items-center space-x-4">
            <Button
              variant="default"
              className="rounded-none hidden md:inline-flex bg-[var(--klutr-coral)] hover:bg-[var(--klutr-coral)]/90 font-mono"
            >
            ...
            <Sheet>
              ...
              <SheetContent>
                <nav className="flex flex-col gap-6 mt-6">
                  ...
                  <Button className="cursor-pointer rounded-none bg-[var(--klutr-coral)] hover:bg-[var(--klutr-coral)]/90 font-mono">
                    GET STARTED <ArrowRight className="ml-1 w-4 h-4" />
                  </Button>
                </nav>
              </SheetContent>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            >
              {labels.map((feature, index) => (
                ...
                >
                  <feature.icon className="h-5 w-5 text-[var(--klutr-coral)]" />
            ...
            >
              <Button
                size="lg"
                className="cursor-pointer rounded-none mt-12 bg-[var(--klutr-coral)] hover:bg-[var(--klutr-coral)]/90 font-mono"
              >
                GET STARTED <ArrowRight className="ml-1 w-4 h-4" />
              </Button>
            </motion.div>
        ...
        <section className="container" ref={ref}>
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                <div className="mb-6 rounded-full bg-[var(--klutr-coral)]/10 p-4">
                  <feature.icon className="h-8 w-8 text-[var(--klutr-coral)]" />
                </div>
