...
const UX_COLORS_MAPPING: Record<IllustrationUseCase, string | null> = {
  'stream-capture': 'cloud-connecting-1',
  'ai-clustering': 'chatting-with-bot-2',
  'search': 'fast-email', // Using fast-email as search placeholder
  'mindstorm': 'gears',
  'stacks-boards': 'folder-not-found',
  'vault': 'fingerprint-passcode',
  'drop-step': 'cloud-download-1',
  'organize-step': 'cloud-data-exchange',
  'discover-step': 'phone-message',
  'empty-notes': 'empty-wallet-2',
  'empty-chat': 'phone-message',
  'empty-files': 'folder-not-found',
  'onboarding-intro': 'avatar-neutral-check',
  'onboarding-complete': 'paper-plane',
  'error-404': 'phone-error',
  'error-fatal': 'skull-2',
  'error-network': 'phone-error',
